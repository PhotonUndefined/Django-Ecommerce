...
def billing_info(request):
    if request.method == "POST":
        ...
        if request.user.is_authenticated:
            ...
            return render(request, "payment/billing_info.html", {"cart_products":cart_products, "quantities": quantities, "totals": totals, "shipping_info": request.POST or None, "billing_form": billing_form})
        else:
